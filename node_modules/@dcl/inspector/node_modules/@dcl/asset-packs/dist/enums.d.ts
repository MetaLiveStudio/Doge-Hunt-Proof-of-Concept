...
export declare const ComponentName: {
    ...
    readonly COUNTER_BAR: string;
    readonly ADMIN_TOOLS: string;
    readonly VIDEO_SCREEN: string;
    readonly REWARDS: string;
    readonly TEXT_ANNOUNCEMENTS: string;
    readonly VIDEO_CONTROL_STATE: string;
...
export declare enum TeleportMode {
...
export declare enum TextureMovementType {
    TMT_OFFSET = 0,
    TMT_TILING = 1
}
