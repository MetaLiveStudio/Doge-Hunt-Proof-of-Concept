...
async function getPublishableFiles(components, projectRoot) {
    ...
    const allFiles = (0, fs_1.globSync)('**/*', {
        cwd: projectRoot,
        ...
        exclude: (entry) => {
            const name = typeof entry === 'string' ? path_1.default.basename(entry) : entry.name;
            return name.startsWith('.') || name === 'node_modules';
        }
    });
    return ig.filter(allFiles).filter((file) => (0, fs_1.statSync)((0, path_1.resolve)(projectRoot, file)).isFile());
}
/**
