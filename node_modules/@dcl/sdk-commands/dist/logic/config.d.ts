 ...
 */
export declare function getInstalledPackageVersionInsidePackage(components: Pick<CliComponents, 'fs'>, packageName: string, packageRootName: string, workingDirectory: string): Promise<string>;
/**
...
export declare function getStorageSegmentKey(): "CU6aHB0OedZQxKVcH9lMMnkDx1MMxROY" | "SXbdxJJqFKdDQ0hnt4I4E3Ejc2FAK6V7";
