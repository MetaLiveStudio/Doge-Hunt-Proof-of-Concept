...
declare function createTweens(targetEngine: IEngine): {
    startTranslation: (entity: Entity, start: any, end: any, duration: number, interpolationType?: InterpolationType, onFinish?: OnFinishCallback) => void;
    stopTranslation: (entity: Entity) => void;
    startRotation: (entity: Entity, start: any, end: any, duration: number, interpolationType?: InterpolationType, onFinish?: OnFinishCallback) => void;
    stopRotation: (entity: Entity) => void;
    startScaling: (entity: Entity, start: any, end: any, duration: number, interpolationType?: InterpolationType, onFinish?: OnFinishCallback) => void;
